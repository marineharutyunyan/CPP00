...
void Bureaucrat::executeForm(AForm const & obj) {
    ...
    {
        std::cout << this->getName() << " couldn’t execute " << obj.getName() << " because of " << e.what() << std::endl;
    }
}
...
void Bureaucrat::signForm(AForm &obj)
{
    ...
    {
        std::cerr << this->getName() << " couldn’t sign " << obj.getName() << " because of " << e.what() << std::endl;
    }
}
